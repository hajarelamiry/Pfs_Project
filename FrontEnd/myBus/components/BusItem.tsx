...
import type { Bus } from "../app/types"
      ...
      <View style={styles.middleSection}>
        ...
        <View style={styles.routeInfo}>
          <Text style={styles.routeText} numberOfLines={1}>
            {bus.startStation} → {bus.endStation}
          </Text>
        </View>
        <View style={styles.stationsInfo}>
          <Ionicons name="location" size={14} color="#666" />
          <Text style={styles.stationsText}>{bus.stations.length} arrêts</Text>
        </View>
      </View>

      <View style={styles.rightSection}>
        <View style={[styles.statusIndicator, { backgroundColor: statusColor }]} />
        <Text style={styles.timeText}>{bus.nextArrival}</Text>
