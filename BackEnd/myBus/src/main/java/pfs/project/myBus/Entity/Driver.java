...
public class Driver extends User{
    ...
    public Driver(String firstName, String lastName, String email, Role role, String passwordHash, String phone) {
        super(firstName,lastName,email, role, passwordHash);
        this.phone = phone;
    }
